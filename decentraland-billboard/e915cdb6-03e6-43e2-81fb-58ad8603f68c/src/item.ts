...
export default class Button implements IScript<Props> {
  openClip = new AudioClip('e915cdb6-03e6-43e2-81fb-58ad8603f68c/sounds/open.mp3')
  closeClip = new AudioClip('e915cdb6-03e6-43e2-81fb-58ad8603f68c/sounds/close.mp3')
  ...
  spawn(host: Entity, props: Props, channel: IChannel) {
    ...
    door.addComponent(new GLTFShape('e915cdb6-03e6-43e2-81fb-58ad8603f68c/models/Door_Genesis.glb'))
